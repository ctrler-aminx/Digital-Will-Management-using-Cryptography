...
all: dwms will home ca/ca_server generate_data

dwms: $(OBJECTS)
	@mkdir -p bin
	$(CXX) $(CXXFLAGS) -o bin/dwms $(OBJECTS) -lssl -lcrypto

will: $(SRC_DIR)/will.cpp
	@mkdir -p bin
	$(CXX) $(CXXFLAGS) -o bin/will $(SRC_DIR)/will.cpp -lssl -lcrypto

home: $(SRC_DIR)/home.cpp $(OBJ_DIR)/encryption.o
	@mkdir -p bin
	$(CXX) $(CXXFLAGS) -o bin/home $(SRC_DIR)/home.cpp $(OBJ_DIR)/encryption.o -lssl -lcrypto
...
generate_data: $(SRC_DIR)/ca_data_generator.cpp $(SRC_DIR)/encryption.cpp
	@mkdir -p bin
	$(CXX) $(CXXFLAGS) -o bin/generate_data $(SRC_DIR)/ca_data_generator.cpp $(SRC_DIR)/encryption.cpp -lssl -lcrypto
